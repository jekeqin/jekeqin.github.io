...
{
	var unit_id     = "3495865";
	var client_ip   = "101.226.178.70";
	var server_time = "1406257089";
	var verify_code = "b8684350";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/3495865/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
